...
import { SectionErrorBoundary, ComponentErrorBoundary } from '../error/ErrorBoundary';
import {
  BookOpen,
  Trophy,
  Clock,
...
export function UserDashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Header */}
      <SectionErrorBoundary component="DashboardHeader">
      ...
      {/* Stats Overview */}
      <SectionErrorBoundary component="StatsOverview">
      ...
      <SectionErrorBoundary component="DashboardTabs">
