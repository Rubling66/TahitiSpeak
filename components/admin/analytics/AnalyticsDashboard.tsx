...
const AnalyticsDashboard = React.memo<AnalyticsDashboardProps>(({ className }) => {
  ...
  }, [dateRange, exportFormat, analyticsService]);
  ...
  ), [learningMetrics, courseAnalytics]);

  const CoursesTab = useMemo(() => (
    <div className="space-y-6">
  ...
  // Helper functions for generating mock datachart data
